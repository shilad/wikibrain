...
public class TestLocalLinkDao3 {
    ...
    public void testLink() throws ClassNotFoundException, IOException, DaoException {
        ...
        for (int i = 1; i <= 200; i++) {
            ...
            for (LocalLink link : matrixDao.getLinks(lang, i+ STARTING_ID, true)) {
            ...
            ids.clear();
            for (LocalLink link : matrixDao.getLinks(lang, i+ STARTING_ID, false)) {
