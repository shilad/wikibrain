...
public class GraphicLoader extends JFrame implements ItemListener{
    ...
    public void createConfig() {
        ...
        ref += String.format("// A default configuration file in HOCON format, almost JSON format\n" +
                ...
                "maxThreads : %s", maxThread.getText());
        ...
        if(dataSourceSelection.getSelectedIndex() == 0){
            ref += String.format("// data access objects\n" +
                    "dao : {\n" +
                    "    dataSource : {\n" +
                    "        default : h2\n" +
                    "        h2 : {\n" +
            ...
            ref += String.format("// data access objects\n" +
                    ...
                    "           connectionsPerPartition : 2\n" +
                    "        }\n" +
                    "    }", postgresHost.getText(), postgresDB.getText(), username.getText(), new String(pass.getPassword()));
        }

        ref += String.format("metaInfo : {\n" +
                "        default : sql\n" +
                "        sql : {\n" +
                "            type : sql\n" +
                "            dataSource : default\n" +
                ...
                "integration {\n" +
                "    dir : ${baseDir}\"/backup\"\n" +
                "}", postgresHost.getText(), portNo.getText(), postgresSpatialDB.getText(), username.getText(), new String(pass.getPassword()));
        ...
        try {
            ...
            String loader = new String("./wb-java.sh org.wikibrain.dao.loader.Loader");
            loader += (" -l " + language.getText() + " ");

            if(basicWikipediaButton.isSelected()){
                loader += "-s fetchlinks -s download -s dumploader -s redirects -s wikitext ";
            }
