...
/**
 * Spatial utilities class copied directly from thesis wikAPIdia.
 */
public class SpatialUtils {

    public static enum ShapeType {POINT, POLYLINE, POLYGON};

    public static Geometry mergeGeometries(Geometry g1, Geometry g2) throws WikapidiaException{
        ...
        if (t1 > t2){
            ...
            if (t1 == ShapeType.POINT.ordinal()){
                ...
                throw new WikapidiaException("Cannot currently merge non-point-based geometries");
            }
        }

    }

    private static List<Point> getPointsFromPointType(Geometry g) throws WikapidiaException{
        ...
        if (g instanceof Point){
            ...
            throw new WikapidiaException("Cannot get points of geometry that is not Point or MultiPoint");
        }
        return rVal;

    }

    public static ShapeType getShapeType(Geometry g) throws WikapidiaException{
        ...
        if (g.getGeometryType().equals("Point") || g.getGeometryType().equals("MultiPoint")){
            ...
            throw new WikapidiaException("Geometry of illegal shape type encountered");
        }
