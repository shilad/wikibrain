...
//TODO: RemotePageDao cannot extend Dao now because it cannot implement operations that require modifying the data store

public interface RemotePageDao<T extends RemotePage>{
     ...
     * @return the requested RemotePage
