...
public class TsneDemoWBData {
    public static void main(String [] args) {
        ...
        double [][] X = MatrixUtils.simpleRead2DMatrix(new File("/Users/research/Desktop/wikibrain/wikibrain-cookbook/src/main/java/org/wikibrain/cookbook/tsne/data/vecs.txt"), ",");
        ...
        saveFile(new File("Java-tsne-WB-results2000.txt"), MatrixOps.doubleArrayToString(Y));
