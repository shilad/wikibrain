...
public class TsneDemoWBData {
    public static void main(String [] args) {
        ...
        double [][] X = MatrixUtils.simpleRead2DMatrix(new File("/Users/research/wikibrain/wikibrain-cookbook/src/main/java/org/wikibrain/cookbook/tsne/data/vecssmaller.txt"), ",");
        System.out.println(MatrixOps.doubleArrayToPrintString(X, ", ", 50,10));
        TSne tsne = new FastTSne();
       double [][] Y = tsne.tsne(X, 2, initial_dims, perplexity, 100);

        // Plot Y or save Y to file and plot with some other tool such as for instance R
        saveFile(new File("Java-tsne-testing-vecssmaller-results.txt"), MatrixOps.doubleArrayToString(Y));
