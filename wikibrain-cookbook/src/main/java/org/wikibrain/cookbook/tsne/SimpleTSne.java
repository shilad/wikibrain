...
import static org.wikibrain.cookbook.tsne.MatrixOps.abs;
import static org.wikibrain.cookbook.tsne.MatrixOps.addColumnVector;
import static org.wikibrain.cookbook.tsne.MatrixOps.addRowVector;
import static org.wikibrain.cookbook.tsne.MatrixOps.assignAllLessThan;
import static org.wikibrain.cookbook.tsne.MatrixOps.assignAtIndex;
import static org.wikibrain.cookbook.tsne.MatrixOps.assignValuesToRow;
import static org.wikibrain.cookbook.tsne.MatrixOps.biggerThan;
import static org.wikibrain.cookbook.tsne.MatrixOps.concatenate;
import static org.wikibrain.cookbook.tsne.MatrixOps.diag;
import static org.wikibrain.cookbook.tsne.MatrixOps.equal;
import static org.wikibrain.cookbook.tsne.MatrixOps.exp;
import static org.wikibrain.cookbook.tsne.MatrixOps.fillMatrix;
import static org.wikibrain.cookbook.tsne.MatrixOps.getValuesFromRow;
import static org.wikibrain.cookbook.tsne.MatrixOps.log;
import static org.wikibrain.cookbook.tsne.MatrixOps.maximum;
import static org.wikibrain.cookbook.tsne.MatrixOps.mean;
import static org.wikibrain.cookbook.tsne.MatrixOps.negate;
import static org.wikibrain.cookbook.tsne.MatrixOps.plus;
import static org.wikibrain.cookbook.tsne.MatrixOps.range;
import static org.wikibrain.cookbook.tsne.MatrixOps.replaceNaN;
import static org.wikibrain.cookbook.tsne.MatrixOps.rnorm;
import static org.wikibrain.cookbook.tsne.MatrixOps.scalarDivide;
import static org.wikibrain.cookbook.tsne.MatrixOps.scalarInverse;
import static org.wikibrain.cookbook.tsne.MatrixOps.scalarMult;
import static org.wikibrain.cookbook.tsne.MatrixOps.scalarPlus;
import static org.wikibrain.cookbook.tsne.MatrixOps.sqrt;
import static org.wikibrain.cookbook.tsne.MatrixOps.square;
import static org.wikibrain.cookbook.tsne.MatrixOps.sum;
import static org.wikibrain.cookbook.tsne.MatrixOps.tile;
import static org.wikibrain.cookbook.tsne.MatrixOps.times;
