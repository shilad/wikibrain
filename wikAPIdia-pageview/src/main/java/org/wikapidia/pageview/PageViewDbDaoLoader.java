 ...
 */
public class PageViewDbDaoLoader {
    private static final Logger LOG = Logger.getLogger(PageViewDbDaoLoader.class.getName());
    private final LanguageSet languageSet;
    private final PageViewDbDao dao;

    public PageViewDbDaoLoader(LanguageSet languageSet, PageViewDbDao dao) {
        this.languageSet = languageSet;
        this.dao = dao;
    }

    public PageViewDbDao getDao() {
        return dao;
    }
    ...
    public static void main(String args[]) throws ClassNotFoundException, SQLException, IOException, ConfigurationException, WikapidiaException, DaoException {
        ...
        try {
            ...
            new HelpFormatter().printHelp("PageViewDbDaoLoader", options);
            return;
        }
        ...
        try {
            ...
            PageViewDbDao dao = conf.get(PageViewDbDao.class);
            final PageViewDbDaoLoader loader = new PageViewDbDaoLoader(env.getLanguages(), dao);
