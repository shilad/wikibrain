 ...
 * A data source for
 */
public class LocalPageSqlDao<T extends LocalPage> extends LocalPageDao {
    protected final SQLDialect dialect;
    protected DataSource ds;

    public LocalPageSqlDao(DataSource dataSource) throws SQLException {
        ds = dataSource;
    ...
    @Override
    public LocalArticle getByPageId(Language language, int pageId) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }

    @Override
    public LocalArticle getByTitle(Language language, Title title, PageType ns) {
        return null;  //To change body of implemented methods use File | Settings | File Templates.
    }
     ...
     *
     */
    public static class Provider extends org.wikapidia.conf.Provider<LocalPageSqlDao> {
        ...
        public Class getType() {
            return LocalPageSqlDao.class;
        }

        @Override
        public LocalPageSqlDao get(String name, Config config) throws ConfigurationException {
            ...
            try {
                return new LocalPageSqlDao(dataSource);
