 ...
 * @author Shilad Sen
 */
class LangLinkProbabilityDao {
    private static final Logger LOG = LoggerFactory.getLogger(LangLinkProbabilityDao.class);
    ...
    LangLinkProbabilityDao(RawPageDao pageDao, PhraseAnalyzerDao phraseDao, Language lang, StringNormalizer normalizer, File path) throws DaoException {
        this.path = path;
        this.lang = lang;
