...
public class UniversalMilneWitten extends BaseUniversalSRMetric {
    ...
    @Override
    public void writeCosimilarity(String path, int maxHits) throws IOException, DaoException, WikiBrainException{
...
//        super.writeCosimilarity(path, maxHits, pairwiseSimilarity);
    ...
    public static class Provider extends org.wikibrain.conf.Provider<UniversalSRMetric> {
