...
public class Wikifier {
    private static final Logger LOG = Logger.getLogger(Wikifier.class.getName());
    ...
    public List<LocalLink> wikify(int wpId) throws DaoException {
        ...
        return wikify(wpId, rp.getPlainText());
    }
...
//            }
    ...
    public static void main(String args[]) throws ConfigurationException, DaoException, IOException {
        ...
        Wikifier w = c.get(Wikifier.class, "default", "language", "simple");
        w.testWikify();
    }
}
